...
router.get('/Them',function (req , res,next ){
  Anh.find({},function (err,data){
    res.render('Them',{title : 'Them', data : data});
  })
});
var dbb = "mongodb+srv://hoathmph15543:haminhhoat@cluster0.zmyqv.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
router.get('/DanhSachAll' , function (req , res, next){
  Anh.find({},function (err , data){
    res.send( data );
  });
});
